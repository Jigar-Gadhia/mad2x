        ...
        <View style={Styles.image_view}>
          {index === 0 ? (
            <ImageBackground
              ...
              source={item.path}>
              <Image
                style={{height: hp('1%'), resizeMode: 'contain'}}
    ...
    return (
      <Animated.View entering={FadeIn.delay(50 * index)}>
        <TouchableOpacity
          style={[
            Styles.options_btn,
            index == 1 || index == 3 ? {marginLeft: wp('3.5%')} : null,
          ]}>
          <Image
            ...
            key={index}
          />
          <Text style={{color: Colors.dark_grey}} key={item.text}>
            {item.text}
          </Text>
        </TouchableOpacity>
      </Animated.View>
  ...
  return !data ? (
    ...
    <Animated.View
      ...
      <Text style={{fontSize: 20, color: Colors.black}}>
        ...
        <Text style={{color: Colors.red}}> re-login !</Text>
      </Text>
      <TouchableOpacity
        style={{
          borderRadius: 10,
          ...
          <Animated.View entering={FadeIn} style={Styles.profile_header}>
            <View
              ...
              <View
                ...
                <Image
                  ...
                  source={{
                    uri: url === '' || url === undefined ? default_image : url,
                  }}
                />
                <TouchableOpacity
                  style={Styles.profile_btn}
                  onPress={() =>
                    navigation.navigation.navigate('Edit_Profile')
                  }>
                  <Text
                    accessibilityLabel="Profile button"
                    style={Styles.profile_btn_text}>
                    My Profile
                  </Text>
                </TouchableOpacity>
              </View>
            ...
            <View style={Styles.profile_text_view}>
              <Text
                ...
                style={Styles.profile_header_text}>
                {data.email}
              </Text>
              <Text accessibilityLabel="Age" style={Styles.profile_text_main}>
                {data.age} Years
              </Text>
              <Text
                accessibilityLabel="Address"
                style={Styles.profile_text_main}>
                {data.address}
              </Text>
            </View>
          </Animated.View>
