  ...
  return (
    <View style={Styles.container}>
      <View style={Styles.bg}>
        <View style={Styles.back_view}></View>
        <View style={Styles.success_view}>
          <ImageBackground
            source={require('../images/success_background.png')}
            resizeMode="contain"
          ...
          <View
            ...
            <Text style={[Styles.success_text, {marginTop: hp('3%')}]}>
              Redirecting to Login screen
            </Text>
            <ActivityIndicator
              size={'large'}
              color={Colors.date}
              style={{height: hp('1%'), marginTop: hp('3%')}}
            />
          </View>
        </View>
      </View>
